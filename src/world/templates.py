...
def build_room_basic_template(  # constructs the canonical 8x8x3m room with floor, ceiling, and four walls
    ...
    nodes = [
        {
            "id": "floor",  # the main walking surface; marked teleportable for VR navigation
            "kind": "plane",
...
def build_template_geometry(template_id: str) -> Dict[str, Any]:  # factory dispatch; currently only room_basic is supported
